    ...
    public String selectMovie(){
        ...
        if(MovieManager.getTotalNumofMovies() == 0){
            ...
            if (choice == movieList.size() + 1) {
                ...
                for (int i=0; i<cast.length; i+=1) System.out.println("\t" + cast[i]);
                System.out.println("Overall Rating: " + Integer.toString(selectedMovie.getOverallRating()));
                System.out.println("Ticket Sales:" + Integer.toString(selectedMovie.getTicketSales()));
            ...
            do {
                ...
                switch(choice){
                    ...
                    case 2:
                        ...
                        //ReviewView reviewView = new ReviewView(movieList.get(choice - 1), this.path + " > Movies");
                        //reviewView.viewApp();
                        break;
                    case 3:
                        selectedMovieId = selectMovie();
